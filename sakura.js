...
var Sakura = function Sakura(selector, options) {
    ...
    var defaults = {
        ...
        colors: [
            {
                // You can add multiple colors (chosen randomly) by adding elements to the
                // array.
            ...
            ""
                ...
                .concat((
                    fallTime > 30
                        ? fallTime
                        : 30
                ) - 20 + randomInt(0, 20), "s linear 0s infinite"),
            ""
...
Sakura.prototype.stop = function () {
    ...
    var graceful = arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : false;
    var animId = this.el.dataset.sakuraAnimId;
    ...
    if (animId) {
        ...
        this
            .el
            .setAttribute('data-sakura-anim-id', '');
